...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
  <a class="navbar-brand" href="home.php">Boris's Travel Compendium 2, Electric Boogaloo</a>
...
<div class="jumbotron-fluid">
	<h1 class="display-2 text-center text-white">Food for your Soul</h1>
...
<h1 class="display-3 text-center"> Restaurants </h1>
